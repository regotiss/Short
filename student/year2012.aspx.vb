...
Partial Class year2012
    ...
    Sub BindBannerData()
        ...
        adp.SelectCommand = New SqlCommand("Select * from placedstud where year='2012'", con)
        ds = New DataSet
        adp.Fill(ds, "Banner")
    ...
    Sub Binddatacse()
        ...
        con.ConnectionString = "Data Source=.\SQLEXPRESS;AttachDbFilename=E:\TY btech project\App_Data\studdata.mdf;Integrated Security=True;User Instance=True"
        adp = New SqlDataAdapter
        adp.SelectCommand = New SqlCommand("Select * from placedstud where branch='Computer Science' AND year='2012'", con)
        ds = New DataSet
        adp.Fill(ds, "Banner")
    ...
    Sub Binddatait()
        ...
        con.ConnectionString = "Data Source=.\SQLEXPRESS;AttachDbFilename=E:\TY btech project\App_Data\studdata.mdf;Integrated Security=True;User Instance=True"
        adp = New SqlDataAdapter
        adp.SelectCommand = New SqlCommand("Select * from placedstud where branch='IT' AND year='2012'", con)
        ds = New DataSet
        adp.Fill(ds, "Banner")
    ...
    Sub Binddataetc()
        ...
        con.ConnectionString = "Data Source=.\SQLEXPRESS;AttachDbFilename=E:\TY btech project\App_Data\studdata.mdf;Integrated Security=True;User Instance=True"
        adp = New SqlDataAdapter
        adp.SelectCommand = New SqlCommand("Select * from placedstud where branch='Electronics' AND year='2012'", con)
        ds = New DataSet
        adp.Fill(ds, "Banner")
    ...
    Sub Binddatamech()
        ...
        con.ConnectionString = "Data Source=.\SQLEXPRESS;AttachDbFilename=E:\TY btech project\App_Data\studdata.mdf;Integrated Security=True;User Instance=True"
        adp = New SqlDataAdapter
        adp.SelectCommand = New SqlCommand("Select * from placedstud where branch='Mechanical' AND year='2012'", con)
        ds = New DataSet
        adp.Fill(ds, "Banner")
    ...
    Sub Binddatacivil()
        ...
        con.ConnectionString = "Data Source=.\SQLEXPRESS;AttachDbFilename=E:\TY btech project\App_Data\studdata.mdf;Integrated Security=True;User Instance=True"
        adp = New SqlDataAdapter
        adp.SelectCommand = New SqlCommand("Select * from placedstud where branch='Civil' AND year='2012'", con)
        ds = New DataSet
        adp.Fill(ds, "Banner")

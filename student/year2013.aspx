<%@ Page Language="VB" AutoEventWireup="false" CodeFile="year2013.aspx.vb" Inherits="year2013" %>
...
<body>
    ...
    <asp:DataGrid ID="DataGrid2" runat="server" AllowPaging="True" AllowSorting="True"
         ...
         <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            PageSize="5" 
            Style="z-index: 103; left: 130px; position: absolute; top: 555px; width: 904px; height: 232px;" 
            BorderColor="Black" BorderStyle="Solid" BorderWidth="2px" 
            CellPadding="3" Font-Bold="True" Font-Size="Large" ForeColor="Red">
            <PagerStyle Mode="NumericPages" BackColor="White" ForeColor="#000066" HorizontalAlign="Left" />
            <Columns>
    ...
    <p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span class="style1">All Selected Students</span></p>
    <p>
        &nbsp;</p>
    <p>
        &nbsp;</p>
    ...
    <p>
        ...
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Italic="True" 
            Font-Size="X-Large" ForeColor="#FF0066" Text="Computer Engineering And Science"></asp:Label>
    </p>
    <p>
        &nbsp;</p>
    <p>
